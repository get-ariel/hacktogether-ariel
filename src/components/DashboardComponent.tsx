...
const INITIAL_LOCATIONS: TripLocation[] = [
  {
    ...
    image:
      "https://welcome-to-times-square.com/wp-content/uploads/2024/03/madison-square-garden-newyorkbyrail-com_89_0_867_539.webp",
    likes: [],
    date: "2024-04-11",
    order: 0,
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/p/AF1QipOXaWSrMF4ixVBuqVK_n3-9lMKS0OSGdkDEN0Db=s1360-w1360-h1020",
    likes: [],
    date: "2024-04-11",
    order: 1,
  },
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex gap-2">
                        ...
                        >
                          <ThumbsUp
                            className={`h-4 w-4 ${
                              myId && location.likes.includes(myId)
                                ? "fill-primary"
                                : ""
                            }`}
                          />
